...
describe("UserService Tests", () => {
  ...
  describe("UserService get user", () => {
    ...
    it("should return Error if user not found", async () => {
      await should(
        UserService.getUser("599357b8a4f9bb09a0e6f13c")
      ).be.rejected();
    });

    it("should return stats with appropriate user id", async () => {
  ...
  describe("UserService edit user", () => {
    ...
    it("should return Error if user not found", async () => {
      await should(
        UserService.editUser("599357b8a4f9bb09a0e6f13c", userT)
      ).be.rejected();
    });
  ...
  describe("UserService delete user", () => {
    ...
    it("should return Error if user not found", async () => {
      await should(
        UserService.deleteUser("599357b8a4f9bb09a0e6f13c")
      ).be.rejected();
    });
